...
import { ArrowRight, TrendingUp, BarChart3, Brain, Sparkles, Zap, Star } from 'lucide-react';
...
const ORB_CONFIG = [
  { size: 500, color: 'oklch(0.55 0.18 250 / 0.25)', top: '-10%', left: '-5%', cls: 'orb-1' },
  { size: 400, color: 'oklch(0.65 0.2 280 / 0.2)', top: '20%', right: '-8%', cls: 'orb-2' },
  { size: 350, color: 'oklch(0.6 0.18 200 / 0.2)', bottom: '-5%', left: '20%', cls: 'orb-3' },
  { size: 300, color: 'oklch(0.7 0.18 320 / 0.15)', top: '50%', left: '40%', cls: 'orb-4' },
  { size: 250, color: 'oklch(0.65 0.2 160 / 0.18)', top: '10%', left: '50%', cls: 'orb-5' },
  { size: 200, color: 'oklch(0.75 0.18 60 / 0.15)', bottom: '20%', right: '15%', cls: 'orb-6' },
];
        ...
        {ORB_CONFIG.map((orb, i) => (
          <div
            ...
            style={{
              ...
              transform: `translate(${orbOffsets.x * (i % 2 === 0 ? 1 : -1)}px, ${orbOffsets.y * (i % 3 === 0 ? 1 : -0.5)}px)`,
            }}
          />
        ))}
        ...
        {Array.from({ length: 15 }).map((_, i) => (
          <div
            ...
            style={{
              width: (i % 3) + 2,
              height: (i % 3) + 2,
              background: `oklch(${0.5 + (i % 3) * 0.1} 0.18 ${200 + i * 10})`,
              top: `${(i * 7) % 100}%`,
              left: `${(i * 13) % 100}%`,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-16 animate-slide-up-fade stagger-5 relative">
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/30 via-purple-500/20 to-cyan-500/20 blur-3xl scale-105 animate-pulse-glow pointer-events-none" style={{ animationDuration: '4s' }} />
            ...
            <div className="absolute -top-4 -right-2 sm:-right-6 bg-card border border-border/50 rounded-2xl p-3 shadow-xl animate-card-enter stagger-7 hover-scale hidden sm:block">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-foreground">&lt; 1 sec</p>
                </div>
              </div>
            </div>
          </div>

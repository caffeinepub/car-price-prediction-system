...
import type { CarSpecs as _CarSpecs, FuelType as _FuelType, PricePredictionResult as _PricePredictionResult, TransmissionType as _TransmissionType, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async predictCarPrice(arg0: CarSpecs): Promise<PricePredictionResult> {
        if (this.processError) {
            try {
                const result = await this.actor.predictCarPrice(to_candid_CarSpecs_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CarSpecs_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CarSpecs): CarSpecs {
...
function from_candid_tuple_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_CarSpecs, _PricePredictionResult]): [CarSpecs, PricePredictionResult] {
    return [
        from_candid_CarSpecs_n18(_uploadFile, _downloadFile, value[0]),
        value[1]
    ];
}
...
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_CarSpecs, _PricePredictionResult]>): Array<[CarSpecs, PricePredictionResult]> {
    return value.map((x)=>from_candid_tuple_n17(_uploadFile, _downloadFile, x));
}
function to_candid_CarSpecs_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CarSpecs): _CarSpecs {
    return to_candid_record_n25(_uploadFile, _downloadFile, value);
}
function to_candid_FuelType_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FuelType): _FuelType {
    return to_candid_variant_n29(_uploadFile, _downloadFile, value);
}
function to_candid_TransmissionType_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TransmissionType): _TransmissionType {
...
function to_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        mileage: value.mileage,
        owners: value.owners,
        transmission: to_candid_TransmissionType_n26(_uploadFile, _downloadFile, value.transmission),
        fuelType: to_candid_FuelType_n28(_uploadFile, _downloadFile, value.fuelType),
        modelYear: value.modelYear,
        brand: value.brand,
        usageDuration: value.usageDuration,
        yearOfPurchase: value.yearOfPurchase
...
function to_candid_variant_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TransmissionType): {
    automatic: null;
} | {
    manual: null;
} {
...
function to_candid_variant_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FuelType): {
    petrol: null;
} | {
    hybrid: null;
} | {
